...
const Novedades = () => {
    ...
    const LibrosNovedades = items.content.filter(libro => libro.novedad)
        ...
        <>
            ...
            <div className="listaLibros-container">
                <div className="listaLibros-title-container">
                    <h1 className="listaLibros-subtitle" style={{ marginTop: '60px' }}>Nuestras novedades</h1>
                </div>
            <hr />
            {loading ? (
                <LoadingSpinner />
                ...
                <>
                    {LibrosNovedades.length > 0 && (
                        <ListaLibrosListaLibros libros={LibrosNovedades} />
                    )}
                </>
            )}
        </div>
